...
//#define UART0_BASE			( 0x10009000UL )		/* Realview PBX Cortex-A9. */
//#define UART1_BASE			( 0x1000A000UL )		/* Realview PBX Cortex-A9. */
#define UART0_BASE			( 0x1C090000UL )		/* Realview PBX Cortex-A9. */
#define UART1_BASE			( 0x1C0A0000UL )		/* Realview PBX Cortex-A9. */
#define UART_DEVICE_TYPE	0

#define UARTDR(x)			( (unsigned char *)	( (x) + 0x0000UL ) )	/* Data Register */
#define UARTRSR_UARTECR(x)	( (unsigned char *)	( (x) + 0x0004UL ) )	/* Receive Status Register / Error Clear Register */
#define UARTFR(x)			( (unsigned short *)( (x) + 0x0018UL ) )	/* Flag Register */
#define UARTILPR(x)			( (unsigned char *)	( (x) + 0x0020UL ) )	/* IrDA Low-Power Counter Register */
#define UARTIBRD(x)			( (unsigned short *)( (x) + 0x0024UL ) )	/* Integer Baud Rate Register */
#define UARTFBRD(x)			( (unsigned char *)	( (x) + 0x0028UL ) )	/* Fractional Baud Rate Register */
#define UARTLCR_H(x)		( (unsigned char *)	( (x) + 0x002CUL ) )	/* Line Control Register */
#define UARTCR(x)			( (unsigned short *)( (x) + 0x0030UL ) )	/* Control Register */
#define UARTIFLS(x)			( (unsigned char *)	( (x) + 0x0034UL ) )	/* Interrupt FIFO Level Select Register */
#define UARTIMSC(x)			( (unsigned short *)( (x) + 0x0038UL ) )	/* Interrupt Mask Set/Clear Register */
#define UARTRIS(x)			( (unsigned short *)( (x) + 0x003CUL ) )	/* Raw Interrupt Status Register */
#define UARTMIS(x)			( (unsigned short *)( (x) + 0x0040UL ) )	/* Masked Interrupt Status Register */
#define UARTICR(x)			( (unsigned short *)( (x) + 0x0044UL ) )	/* Interrupt Clear Register */
#define UARTDMACR(x)		( (unsigned char *)	( (x) + 0x0048UL ) )	/* DMA Control Register */
#define UARTPeriphID0(x)	( (unsigned char *)	( (x) + 0x0FE0UL ) )	/* UARTPeriphID0 Register */
#define UARTPeriphID1(x)	( (unsigned char *)	( (x) + 0x0FE4UL ) )	/* UARTPeriphID1 Register */
#define UARTPeriphID2(x)	( (unsigned char *)	( (x) + 0x0FE8UL ) )	/* UARTPeriphID2 Register */
#define UARTPeriphID3(x)	( (unsigned char *)	( (x) + 0x0FECUL ) )	/* UARTPeriphID3 Register */
#define UARTPCellID0(x)		( (unsigned char *)	( (x) + 0x0FF0UL ) )	/* UARTPCellID0 Register */
#define UARTPCellID1(x)		( (unsigned char *)	( (x) + 0x0FF4UL ) )	/* UARTPCellID1 Register */
#define UARTPCellID2(x)		( (unsigned char *)	( (x) + 0x0FF8UL ) )	/* UARTPCellID2 Register */
#define UARTPCellID3(x)		( (unsigned char *)	( (x) + 0x0FFCUL ) )	/* UARTPCellID3 Register */
...
static const unsigned short usBaudRateConfiguration[4][2] = {
		{ 16, 0 },	/* 9600 */
		{ 8, 0 },	/* 28800 */
		{ 4, 0 },	/* 57600 */
		{ 2, 0 }	/* 115200 */
...
unsigned long ulVectorID = 0;
	...
	*UARTIBRD(ulBase) = usBaudRateConfiguration[ulBaud][0];
	*UARTFBRD(ulBase) = usBaudRateConfiguration[ulBaud][1];

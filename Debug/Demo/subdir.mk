...
Demo/%.o: ../Demo/%.S
	...
	arm-none-eabi-gcc -x assembler-with-cpp -I"/home/wonseok/work/guestos/freertos/FreeRTOS_ARM_Cortex-A15/Demo" -Wall -Wa,-adhlns="$@.lst" -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -mcpu=cortex-a9 -g3 -gdwarf-2 -o"$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
